...
public class OutboxPublisher {
    ...
    public OutboxPublisher(DatabaseClient db) {
        this.db = db;
    }

    public Mono<Long> persistEvent(
            String aggregateType, String aggregateId, String eventType, String payload, Map<String, String> headers) {
        ...
        return db.sql("INSERT INTO message_outbox (aggregate_type, aggregate_id, event_type, payload, headers, status) "
                ...
                .one()
                .doOnSuccess(id -> log.debug(
                        "Outbox event persisted id={} type={} agg={}:{}", id, eventType, aggregateType, aggregateId));
    }
