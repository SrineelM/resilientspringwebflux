...
/**
 * A flexible {@link WebFilter} that applies rate limiting with a smart key resolution strategy.
 * <p>
 ...
 * Features:
 * <ul>
 *   <li>Resolves rate limit key by user principal if authenticated, else by client IP address.</li>
 *   <li>Logs rate limit exceedance with key information.</li>
 *   <li>Returns HTTP 429 (Too Many Requests) if limit is exceeded.</li>
 *   <li>Works with any ReactiveRateLimiter implementation.</li>
 * </ul>
 */
public class RateLimitingWebFilter implements WebFilter {
     ...
     *
     * @param rateLimiter The reactive rate limiter service (e.g., RedisReactiveRateLimiter or InMemoryReactiveRateLimiter).
     */
    public RateLimitingWebFilter(ReactiveRateLimiter rateLimiter) {
